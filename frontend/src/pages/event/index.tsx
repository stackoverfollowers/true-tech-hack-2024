...
const dummy_place = {
  ...
  image_url:
    'https://live.mts.ru/image/venues/teatr-aleko-3a9480d2-8ca0-4f32-8674-aaf995e7d0f3.jpg',
  description: null,
        ...
        <div>
          ...
          <Box sx={{ color: 'text.primary' }} className={styles.description}>
            {description || (
              <>
                <p>
                  {name} - это удивительное произведение, которое завоевало сердца зрителей по всему
                  миру. Созданное в результате творческого сотрудничества талантливых художников,
                  оно представляет собой уникальное сочетание искусства и эмоций.
                </p>
                <p>
                  Впервые представленное публике в далеком году, {name} до сих пор остается
                  актуальным и захватывающим для зрителей. В новой интерпретации события, режиссер
                  возвращает к его первоначальной задумке, сохраняя его уникальный характер и
                  глубокий смысл. Авторы события вносят в него новые элементы, обогащая его
                  духовностью, фольклором и современными музыкальными тенденциями.
